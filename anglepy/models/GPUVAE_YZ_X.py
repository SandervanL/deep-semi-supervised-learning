...
class GPUVAE_YZ_X(ap.GPUVAEModel):
    ...
    def __init__(self, get_optimizer, n_x, n_y, n_hidden_q, n_z, n_hidden_p, nonlinear_q='softplus',
                 nonlinear_p='softplus', type_px='bernoulli', type_qz='gaussianmarg', type_pz='gaussianmarg',
                 prior_sd=1, init_sd=1e-3, var_smoothing=0, n_mixture=0, uniform_y=False):
