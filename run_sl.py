...
from anglepy.models.GPUVAE_YZ_X import GPUVAE_YZ_X
import sys
...
if dataset == 'mnist':
    ...
    n_hidden = 500, 500
    updates = None
    model = GPUVAE_YZ_X(updates, n_x, n_y, n_hidden, n_z, n_hidden, 'softplus', 'softplus', type_px='bernoulli',
...
n_samples = 1000
print('Computing class posteriors using a marginal likelihood estimate with importance sampling using ', n_samples,
      ' samples.')
print(
    'This is slow, but could be sped up significantly by fitting a classifier to match the posteriors (of the '
    'generative model) in the training set.')
